...
public class Reference
{
    ...
    public final static String CLIENT_PROXY = "thatguy.mod.miningspeed2.proxy.ClientProxy";
    public final static String COMMON_PROXY = "thatguy.mod.miningspeed2.proxy.CommonProxy";
}
